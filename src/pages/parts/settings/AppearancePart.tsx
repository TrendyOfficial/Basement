...
const availableThemes = [
  { id: "default", selector: "theme-default", key: "settings.appearance.themes.default" },
  { id: "classic", selector: "theme-classic", key: "settings.appearance.themes.classic" },
  { id: "blue", selector: "theme-blue", key: "settings.appearance.themes.blue" },
  { id: "teal", selector: "theme-teal", key: "settings.appearance.themes.teal" },
  { id: "red", selector: "theme-red", key: "settings.appearance.themes.red" },
  { id: "gray", selector: "theme-gray", key: "settings.appearance.themes.gray" },
  { id: "green", selector: "theme-green", key: "settings.appearance.themes.green" },
  { id: "forest", selector: "theme-forest", key: "settings.appearance.themes.forest" },
  { id: "mocha", selector: "theme-mocha", key: "settings.appearance.themes.mocha" },
  { id: "pink", selector: "theme-pink", key: "settings.appearance.themes.pink" },
  { id: "noir", selector: "theme-noir", key: "settings.appearance.themes.noir" },
  { id: "ember", selector: "theme-ember", key: "settings.appearance.themes.ember" },
  { id: "acid", selector: "theme-acid", key: "settings.appearance.themes.acid" },
  { id: "spark", selector: "theme-spark", key: "settings.appearance.themes.spark" },
  { id: "grape", selector: "theme-grape", key: "settings.appearance.themes.grape" },
  { id: "spiderman", selector: "theme-spiderman", key: "settings.appearance.themes.spiderman" },
  { id: "wolverine", selector: "theme-wolverine", key: "settings.appearance.themes.wolverine" },
  { id: "hulk", selector: "theme-hulk", key: "settings.appearance.themes.hulk" },
  { id: "popsicle", selector: "theme-popsicle", key: "settings.appearance.themes.popsicle" },
];
            ...
            <div className="mt-5 px-3">
              ...
              <div className="flex w-full gap-1 mt-1">
                {Array(4)
                  .fill(null)
                  .map((_, i) => (
                    <div key={i} className="bg-themePreview-ghost bg-opacity-10 w-full h-20 rounded" />
                  ))}
              </div>
            </div>
          </div>
...
export function AppearancePart(props: {
  ...
  const checkScrollPosition = () => {
    ...
    setIsAtBottom(Math.abs(container.scrollHeight - container.scrollTop - container.clientHeight) < 2);
  };
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          {/* Discover Section */}
          <div>
            <p className="text-white font-bold mb-3">{t("settings.appearance.options.discover")}</p>
            <p className="max-w-[25rem] font-medium">{t("settings.appearance.options.discoverDescription")}</p>
            <div
              onClick={() => {
                if (!props.enableLowPerformanceMode) {
                  const newDiscoverValue = !props.enableDiscover;
                  props.setEnableDiscover(newDiscoverValue);
                  if (!newDiscoverValue) props.setEnableFeatured(false);
                }
              }}
              className={classNames(
          ...
          {props.enableDiscover && !props.enableLowPerformanceMode && (
            <div className="pt-4 pl-4 border-l-8 border-dropdown-background">
              <p className="text-white font-bold mb-3">{t("settings.appearance.options.featured")}</p>
              <p className="max-w-[25rem] font-medium">{t("settings.appearance.options.featuredDescription")}</p>
              <div
          ...
          {/* Details Modal */}
          <div>
            <p className="text-white font-bold mb-3">{t("settings.appearance.options.modal")}</p>
            <p className="max-w-[25rem] font-medium">{t("settings.appearance.options.modalDescription")}</p>
            <div
              onClick={() =>
                !props.enableLowPerformanceMode &&
          ...
          {/* Image Logos */}
          <div>
            <p className="text-white font-bold mb-3">{t("settings.appearance.options.logos")}</p>
            <p className="max-w-[25rem] font-medium">{t("settings.appearance.options.logosDescription")}</p>
          ...
          {/* Carousel View */}
          <div>
            <p className="text-white font-bold mb-3">{t("settings.appearance.options.carouselView")}</p>
            <p className="max-w-[25rem] font-medium">{t("settings.appearance.options.carouselViewDescription")}</p>
            <div
              onClick={() => setEnableCarouselView(!props.enableCarouselView)}
              className="bg-dropdown-background hover:bg-dropdown-hoverBackground select-none my-4 cursor-pointer space-x-3 flex items-center max-w-[25rem] py-3 px-4 rounded-lg"
            >
        ...
        <div className="space-y-8">
          <div
            ref={carouselRef}
            className={classNames(
              "grid grid-cols-2 gap-4 max-w-[600px] max-h-[36rem] md:max-h-[64rem] overflow-y-auto vertical-carousel-container",
              {
